...
<head>
<meta charset="utf-8">
<title>StickiesUK - Lake Celestine</title>
...
<body>
    ...
    <div class="product-page">
        ...
        <div class="breadcrumbs caption1">
            ...
            <i class='bx bx-chevron-right bx-xs prev'></i>
            <a href ="#" class="current">Lake Celestine</a>
        </div>
        ...
        <div class="product-overview">
            <!-- Left: Carousel -->
            <div class="carousel">
                <div class="carousel__item"><img src="../../images/category/201.png"/></div>
                <div class="carousel__item"><img src="../../images/category/201-2.png"/></div>
                <div class="carousel__item"><img src="../../images/category/000.png"/></div>

                <div class ="carousel__nav"> 
                    <span class="carousel__button"><img src="../../images/category/201.png"/></span>
                    <span class="carousel__button"><img src="../../images/category/201-2.png"/></span>
                    <span class="carousel__button"><img src="../../images/category/000.png"/></span>
                </div>
            </div>
            <!-- Right: Name, Price, Qty input, Add to Cart, Description -->
            <div class="product-details">
                <h2>Lake Celestine</h2>
                ...
                <form method="post" action="201.php?action=add&code=201"> <!-- action == `add` & gets code of product added to cart -->
                        <!-- CART BUTTON -->
                ...
                <div class="description body2">
                    ...
                    Bursting with the lightness of spring, Lake Celestine is a fun set that beckons us to have the best manicure whenever life gives us lemons! Set on a base of negative space, Lake Celestine is so impossibly summer-appropriate, it couldn't have us more in the mood for a holiday!
                </div>
            </div>
        </div>
    </div>
