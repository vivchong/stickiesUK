...
<head>
<meta charset="utf-8">
<title>StickiesUK - Floral Symphony</title>
...
<body>
    ...
    <div class="product-page">
        ...
        <div class="breadcrumbs caption1">
            ...
            <i class='bx bx-chevron-right bx-xs prev'></i>
            <a href ="#" class="current">Floral Symphony</a>
        </div>
        ...
        <div class="product-overview">
            <!-- Left: Carousel -->
            <div class="carousel">
                <div class="carousel__item"><img src="../../images/category/101.png"/></div>
                <div class="carousel__item"><img src="../../images/category/101-2.png"/></div>
                <div class="carousel__item"><img src="../../images/category/000.png"/></div>

                <div class ="carousel__nav"> 
                    <span class="carousel__button"><img src="../../images/category/101.png"/></span>
                    <span class="carousel__button"><img src="../../images/category/101-2.png"/></span>
            ...
            <div class="product-details">
                ...
                <form method="post" action="101.php?action=add&code=101"> <!-- action == `add` & gets code of product added to cart -->
                        <!-- CART BUTTON -->
                ...
                <div class="description body2">
                    ...
                    Bursting with the lightness of spring, Floral Symphony is a fun set that beckons us to have the best manicure whenever life gives us lemons! Set on a base of negative space, Floral Symphony is so impossibly summer-appropriate, it couldn't have us more in the mood for a holiday!
                </div>
            </div>
        </div>
    </div>
