...
<head>
<meta charset="utf-8">
<title>StickiesUK - Tangerine Bloom</title>
...
<body>
    ...
    <div class="product-page">
        ...
        <div class="breadcrumbs caption1">
            ...
            <i class='bx bx-chevron-right bx-xs prev'></i>
            <a href ="#" class="current">Tangerine Bloom</a>
        </div>
        ...
        <div class="product-overview">
            <!-- Left: Carousel -->
            <div class="carousel">
                <div class="carousel__item"><img src="../../images/category/301.png"/></div>
                <div class="carousel__item"><img src="../../images/category/301-2.png"/></div>
                <div class="carousel__item"><img src="../../images/category/000.png"/></div>

                <div class ="carousel__nav"> 
                    <span class="carousel__button"><img src="../../images/category/301.png"/></span>
                    <span class="carousel__button"><img src="../../images/category/301-2.png"/></span>
                    <span class="carousel__button"><img src="../../images/category/000.png"/></span>
                </div>
            </div>
            <!-- Right: Name, Price, Qty input, Add to Cart, Description -->
            <div class="product-details">
                <h2>Tangerine Bloom</h2>
                ...
                <form method="post" action="301.php?action=add&code=301"> <!-- action == `add` & gets code of product added to cart -->
                        <!-- CART BUTTON -->
                ...
                <div class="description body2">
                    ...
                    Bursting with the lightness of spring, Tangerine Bloom is a fun set that beckons us to have the best manicure whenever life gives us lemons! Set on a base of negative space, Tangerine Bloom is so impossibly summer-appropriate, it couldn't have us more in the mood for a holiday!
                </div>
            </div>
        </div>
    </div>
